...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointTopMargin;
    private int mPointBottomMargin;
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointTopMargin = BGABannerUtil.dp2px(context, 6);
        mPointBottomMargin = BGABannerUtil.dp2px(context, 6);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        ...
        } else if (attr == R.styleable.BGABanner_banner_pointTopMargin) {
            mPointTopMargin = typedArray.getDimensionPixelSize(attr, mPointTopMargin);
        } else if (attr == R.styleable.BGABanner_banner_pointBottomMargin) {
            mPointBottomMargin = typedArray.getDimensionPixelSize(attr, mPointBottomMargin);
    ...
    private void initView(Context context) {
        ...
        mPointContainerRl.setPadding(mPointContainerLeftRightPadding, mPointTopMargin, mPointContainerLeftRightPadding, mPointBottomMargin);
    ...
    public void setIndicatorTopBottomMarginDp(int marginDp) {
        setIndicatorTopMarginPx(BGABannerUtil.dp2px(getContext(), marginDp));
    }

    public void setIndicatorBottomMarginDp(int marginDp) {
        setIndicatorBottomMarginPx(BGABannerUtil.dp2px(getContext(), marginDp));
    }

    public void setIndicatorTopBottomMarginRes(@DimenRes int resId) {
        setIndicatorTopMarginPx(getResources().getDimensionPixelOffset(resId));
    }

    public void setIndicatorBottomMarginRes(@DimenRes int resId) {
        setIndicatorBottomMarginPx(getResources().getDimensionPixelOffset(resId));
    }

    public void setIndicatorTopMarginPx(int marginPx) {
        mPointTopMargin = marginPx;
        mPointContainerRl.setPadding(mPointContainerLeftRightPadding, mPointTopMargin, mPointContainerLeftRightPadding, mPointTopMargin);
    }

    public void setIndicatorBottomMarginPx(int marginPx) {
        mPointBottomMargin = marginPx;
        mPointContainerRl.setPadding(mPointContainerLeftRightPadding, mPointBottomMargin, mPointContainerLeftRightPadding, mPointBottomMargin);
    }
